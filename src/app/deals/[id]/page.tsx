...
export default async function EscrowDetailPage({
  ...
  return (
    <div className="w-full max-w-6xl mx-auto py-12 px-4">
      <Link
        href="/deals"
        className="text-[10px] font-bold text-slate-500 uppercase tracking-widest hover:text-[#E2725B] transition-colors mb-8 inline-block"
      >
        ← Back to Marketplace
      </Link>
        ...
        <div className="lg:col-span-2 flex flex-col gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              <span className="text-[10px] font-bold text-[#E2725B] uppercase tracking-wider">
                {asset.category}
              </span>
              <span className="text-slate-400 text-[10px]">•</span>
              <span className="text-slate-500 text-[10px] uppercase tracking-wider font-bold">
                Listed by {asset.vendorName}
              </span>
            </div>
          ...
          <div className="mt-6 flex gap-3 text-[10px] text-slate-500 uppercase tracking-wider leading-relaxed">
            ...
            <p>
              Funds are held in secure JCLs Escrow until asset delivery is
              confirmed by both parties. Zero hidden charges.
            </p>
          </div>
        </div>
          ...
          <div className="bg-white dark:bg-[#1C1C1E] p-6 md:p-8 rounded-xl border border-black/10 dark:border-white/10 shadow-xl sticky top-24">
            ...
            <div className="bg-slate-50 dark:bg-black p-4 rounded-lg border border-black/5 dark:border-white/5 mb-8">
              <div className="flex justify-between items-center">
                ...
                <span className="text-2xl font-black text-black dark:text-[#F9F6F0]">
